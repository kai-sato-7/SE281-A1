...
public class MainTest {
  ...
  public static class YourTests extends CliTest {
    ...
    @Test
    public void T4_01_invalid_venue_spaces_only() throws Exception {
      runCommands(CREATE_VENUE, "'   '", "NA", "80", "150");
    ...
    @Test
    public void T4_03_invalid_capacity_float() throws Exception {
    ...
    @Test
    public void T4_04_invalid_base_hire_fee_float() throws Exception {
    ...
    @Test
    public void T4_05_invalid_base_hire_fee_negative() throws Exception {
    ...
    @Test
    public void T4_06_invalid_base_hire_fee_zero() throws Exception {
    ...
    @Test
    public void T4_07_invalid_capacity_zero() throws Exception {
    ...
    @Test
    public void T4_08_nine_venues_saved() throws Exception {
